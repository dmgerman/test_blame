...
multiline_comment|/* parse the output path from the given nid to the target DAC;&n; * when target_dac is 0, try to find an empty DAC;&n; * when with_aa_mix is 0, paths with spec-&gt;mixer_nid are excluded&n; */
r_bool
...
c_func
(paren
l_string|&quot;output-path: depth=%d, %02x/%02x/%02x/%02x/%02x&bslash;n&quot;
comma
"&t;&t;&t;"
id|path-&gt;depth
comma
