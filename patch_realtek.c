...
suffix:semicolon
multiline_comment|/* ALC268 models */
r_enum
(brace
"&t;"
id|ALC267_QUANTA_IL1
comma
"&t;"
id|ALC268_3ST
comma
...
suffix:semicolon
multiline_comment|/* ALC269 models */
r_enum
(brace
"&t;"
id|ALC269_BASIC
...
macro_line|#endif   /* CONFIG_SND_DEBUG */
multiline_comment|/* A switch control to allow the enabling EAPD digital outputs on the ALC26x.&n; * Again, this is only used in the ALC26x test models to help identify when&n; * the EAPD line must be asserted for features to work.&n; */
macro_line|#ifdef CONFIG_SND_DEBUG
macro_line|#define alc_eapd_ctrl_info&t;snd_ctl_boolean_mono_info
r_int
id|alc_eapd_ctrl_get
c_func
(paren
r_struct
id|snd_kcontrol
...
macro_line|#define ALC_EAPD_CTRL_SWITCH(xname, nid, mask) &bslash;&n;&t;{ .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = 0,  &bslash;&n;&t;  .info = alc_eapd_ctrl_info, &bslash;&n;&t;  .get = alc_eapd_ctrl_get, &bslash;&n;&t;  .put = alc_eapd_ctrl_put, &bslash;&n;&t;  .private_value = nid | (mask&lt;&lt;16) }
macro_line|#endif   /* CONFIG_SND_DEBUG */
...
suffix:colon
"&t;"
multiline_comment|/* set EAPD output high */
"&t;&t;"
r_switch
c_cond
(paren
...
comma
"&t;&t;&t;&t;"
id|AC_VERB_SET_CONFIG_DEFAULT_BYTES_0
op_plus
id|i
comma
"&t;&t;&t;&t;"
...
c_func
(paren
l_string|&quot;Internal Playback Switch&quot;
comma
l_int|0x0b
comma
l_int|0x1
...
r_void
id|alc880_medion_rim_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
comma
multiline_comment|/* default ASUS */
"&t;"
id|SND_PCI_QUIRK
c_func
(paren
...
suffix:semicolon
multiline_comment|/* update HP, line and mono out pins according to the master switch */
r_void
id|alc260_hp_master_update
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* change HP and line-out pins */
"&t;"
id|snd_hda_codec_write
c_func
(paren
...
suffix:semicolon
"&t;"
multiline_comment|/* mono (speaker) depending on the HP jack sense */
"&t;"
id|val
op_assign
(paren
...
comma
"&t;"
multiline_comment|/* A switch allowing EAPD to be enabled.  Some laptops seem to use&n;&t; * this output to turn on an external amplifier.&n;&t; */
"&t;"
id|ALC_EAPD_CTRL_SWITCH
c_func
(paren
l_string|&quot;LINE-OUT EAPD Enable Switch&quot;
comma
l_int|0x0f
comma
l_int|0x02
...
c_func
(paren
l_string|&quot;HP-OUT EAPD Enable Switch&quot;
comma
l_int|0x10
comma
l_int|0x02
...
c_func
(paren
l_string|&quot;Mobile Front Playback Switch&quot;
comma
l_int|0x16
comma
l_int|0x0
...
c_func
(paren
l_string|&quot;Mobile Line Playback Volume&quot;
comma
l_int|0x0b
comma
l_int|0x03
...
c_func
(paren
l_string|&quot;Mobile Line Playback Switch&quot;
comma
l_int|0x0b
comma
l_int|0x03
...
comma
"&t;"
multiline_comment|/* Line In pin: use output 1 when in LineOut mode */
"&t;"
(brace
l_int|0x1a
comma
...
(brace
"&t;"
multiline_comment|/* Internal speakers: output 0 (0x0c) */
"&t;"
(brace
l_int|0x18
comma
...
comma
"&t;"
multiline_comment|/* Headphone: output 0 (0x0c) */
"&t;"
(brace
l_int|0x14
comma
...
comma
"&t;"
multiline_comment|/* Front Mic: input vref at 80% */
"&t;"
(brace
l_int|0x19
comma
...
multiline_comment|/* Processes unsolicited events. */
r_void
id|alc885_imac24_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;"
multiline_comment|/* Headphone insertion or removal. */
"&t;"
r_if
c_cond
(paren
...
(brace
"&t;"
multiline_comment|/* Looks like the unsol event is incompatible with the standard&n;&t; * definition.  4bit tag is placed at 26 bit!&n;&t; */
"&t;"
r_if
c_cond
(paren
...
multiline_comment|/* set up GPIO and update auto-muting at initialization */
r_void
id|alc885_imac24_init_hook
c_func
(paren
r_struct
id|hda_codec
...
(paren
l_int|1
multiline_comment|/*i &lt;= AUTO_PIN_FRONT_MIC*/
)paren
(brace
"&t;&t;&t;"
r_if
...
l_int|0
suffix:semicolon
multiline_comment|/* no config found */
"&t;"
id|err
op_assign
id|alc_auto_add_mic_boost
...
l_int|1
suffix:semicolon
multiline_comment|/* config found */
)brace
multiline_comment|/* additional initialization for auto-configuration model */
r_void
id|alc882_auto_init
...
multiline_comment|/* ALC883 has the ALC882-type input selection */
macro_line|#define alc883_mux_enum_put alc882_mux_enum_put
multiline_comment|/*&n; * 2ch mode&n; */
r_struct
id|hda_channel_mode
...
multiline_comment|/* auto-toggle front mic */
multiline_comment|/*&n;static void alc883_mitac_mic_automute(struct hda_codec *codec)&n;{&n;&t;unsigned int present;&n;&t;unsigned char bits;&n;&n;&t;present = snd_hda_codec_read(codec, 0x18, 0,&n;&t;&t;&t;&t;     AC_VERB_GET_PIN_SENSE, 0) &amp; 0x80000000;&n;&t;bits = present ? HDA_AMP_MUTE : 0;&n;&t;snd_hda_codec_amp_stereo(codec, 0x0b, HDA_INPUT, 1, HDA_AMP_MUTE, bits);&n;}&n;*/
r_void
id|alc883_mitac_automute
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* alc883_mitac_mic_automute(codec); */
)brace
r_void
id|alc883_mitac_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
comma
"&t;"
multiline_comment|/* enable unsolicited event */
"&t;"
(brace
l_int|0x15
comma
...
comma
"&t;"
multiline_comment|/* {0x18, AC_VERB_SET_UNSOLICITED_ENABLE, ALC880_MIC_EVENT | AC_USRSP_EN}, */
"&t;"
(brace
)brace
multiline_comment|/* end */
...
comma
"&t;"
multiline_comment|/* CLFE : output 2 (0x0e) */
"&t;"
(brace
)brace
)brace
...
suffix:semicolon
multiline_comment|/* toggle front-jack and RCA according to the hp-jack state */
r_void
id|alc888_lenovo_ms7195_front_automute
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* toggle RCA according to the front-jack state */
r_void
id|alc888_lenovo_ms7195_rca_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_lenovo_ms7195_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_medion_md2_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* toggle speaker-output according to the hp-jack state */
r_void
id|alc883_clevo_m720_hp_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_clevo_m720_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* toggle speaker-output according to the hp-jack state */
r_void
id|alc883_2ch_fujitsu_pi2515_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_2ch_fujitsu_pi2515_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_haier_w66_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* toggle speaker-output according to the hp-jack state */
r_void
id|alc883_acer_aspire_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc883_acer_aspire_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;"
multiline_comment|/* HP Pin: output 0 (0x0c) */
"&t;"
(brace
l_int|0x14
comma
...
r_void
id|alc888_6st_dell_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc262_hp_wildwest_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc262_hp_wildwest_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc262_hp_t5735_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* change hp mute */
"&t;"
id|change
op_assign
...
(brace
"&t;&t;"
multiline_comment|/* change speaker according to HP jack state */
"&t;&t;"
r_struct
id|alc_spec
op_star
...
multiline_comment|/* mute/unmute internal speaker according to the hp jack and mute state */
r_void
id|alc262_lenovo_3000_automute
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* unsolicited event for HP jack sensing */
r_void
id|alc262_lenovo_3000_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* bind hp and internal speaker mute (with plug check) */
r_int
id|alc262_lenovo_3000_master_sw_put
c_func
(paren
r_struct
id|snd_kcontrol
...
(brace
"&t;"
multiline_comment|/* output mixer */
"&t;"
(brace
l_int|0x0c
comma
...
comma
"&t;"
multiline_comment|/* internal mic */
"&t;"
(brace
l_int|0x19
comma
...
comma
"&t;"
multiline_comment|/* ADC, choose mic */
"&t;"
(brace
l_int|0x07
comma
...
suffix:semicolon
"&t;"
multiline_comment|/* auto-mute only when HP is used as HP */
"&t;"
r_if
c_cond
(paren
...
"&t;"
multiline_comment|/* mute/unmute internal speaker */
"&t;"
id|snd_hda_codec_amp_stereo
c_func
(paren
...
suffix:semicolon
"&t;"
multiline_comment|/* mute/unmute HP */
"&t;"
id|snd_hda_codec_amp_stereo
c_func
(paren
...
suffix:semicolon
"&t;"
multiline_comment|/* reprogram the HP pin as mic or HP according to the input source */
"&t;"
id|snd_hda_codec_write_cache
c_func
(paren
...
macro_line|#define alc268_toshiba_automute&t;alc262_hippo_automute
r_struct
id|hda_verb
...
comma
multiline_comment|/* internal dmic? */
"&t;"
(brace
l_int|0x13
comma
...
macro_line|#define alc268_dell_init_hook&t;alc268_dell_automute
r_struct
id|snd_kcontrol_new
...
suffix:semicolon
r_void
id|alc267_quanta_il1_hp_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc267_quanta_il1_mic_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc267_quanta_il1_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;"
multiline_comment|/* Unmute DAC0-1 and set vol = 0 */
"&t;"
(brace
l_int|0x02
comma
...
(brace
"&t;"
multiline_comment|/* set output DAC */
"&t;"
(brace
l_int|0x02
comma
...
suffix:semicolon
macro_line|#define alc268_mux_enum_info alc_mux_enum_info
macro_line|#define alc268_mux_enum_get alc_mux_enum_get
macro_line|#define alc268_mux_enum_put alc_mux_enum_put
r_struct
id|snd_kcontrol_new
...
id|info
op_assign
id|alc268_mux_enum_info
comma
"&t;&t;"
dot
id|get
op_assign
id|alc268_mux_enum_get
comma
"&t;&t;"
dot
id|put
op_assign
id|alc268_mux_enum_put
comma
"&t;"
)brace
comma
...
c_func
(paren
l_string|&quot;Mono sum Playback Switch&quot;
comma
l_int|0x0e
comma
l_int|1
...
c_func
(paren
l_string|&quot;LINE-OUT sum Playback Switch&quot;
comma
l_int|0x0f
comma
l_int|2
...
c_func
(paren
l_string|&quot;HP-OUT sum Playback Switch&quot;
comma
l_int|0x10
comma
l_int|2
...
c_func
(paren
l_string|&quot;HP-OUT Playback Switch&quot;
comma
l_int|0x15
comma
l_int|2
...
c_func
(paren
l_string|&quot;PCM-IN1 Capture Volume&quot;
comma
l_int|0x23
comma
l_int|0x0
...
c_func
(paren
l_string|&quot;PCM-IN1 Capture Switch&quot;
comma
l_int|0x23
comma
l_int|2
...
c_func
(paren
l_string|&quot;PCM-IN2 Capture Volume&quot;
comma
l_int|0x24
comma
l_int|0x0
...
c_func
(paren
l_string|&quot;PCM-IN2 Capture Switch&quot;
comma
l_int|0x24
comma
l_int|2
...
comma
"&t;"
multiline_comment|/* Switches to allow the digital SPDIF output pin to be enabled.&n;&t; * The ALC268 does not have an SPDIF input.&n;&t; */
"&t;"
id|ALC_SPDIF_CTRL_SWITCH
c_func
(paren
...
multiline_comment|/* add playback controls from the parsed DAC table */
r_int
id|alc268_auto_create_multi_out_ctls
c_func
(paren
r_struct
id|alc_spec
...
multiline_comment|/* create playback/capture controls for input pins */
r_int
id|alc268_auto_create_analog_input_ctls
c_func
(paren
r_struct
id|alc_spec
...
suffix:semicolon
"&t;"
multiline_comment|/* digital mics */
"&t;&t;&t;"
r_break
suffix:semicolon
"&t;&t;"
...
r_void
id|alc268_auto_init_mono_speaker_out
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* digital only support output */
"&t;"
r_if
c_cond
(paren
...
macro_line|#define alc268_auto_init_multi_out&t;alc882_auto_init_multi_out
macro_line|#define alc268_auto_init_hp_out&t;&t;alc882_auto_init_hp_out
...
comma
"&t;"
multiline_comment|/* Mute input amps (PCBeep, Line In, Mic 1 &amp; Mic 2) of the&n;&t; * analog-loopback mixer widget&n;&t; * Note: PASD motherboards uses the Line In 2 as the input for&n;&t; * front panel mic (mic 2)&n;&t; */
"&t;"
multiline_comment|/* Amp Indices: Mic1 = 0, Mic2 = 1, Line1 = 2, Line2 = 3, CD = 4 */
"&t;"
(brace
...
multiline_comment|/* FIXME: use matrix-type input source selection */
"&t;"
multiline_comment|/* Mixer elements: 0x18, 19, 1a, 1b, 1d, 0b */
"&t;"
multiline_comment|/* Input mixer1: unmute Mic, F-Mic, Line, CD inputs */
"&t;"
(brace
...
multiline_comment|/* add playback controls from the parsed DAC table */
r_int
id|alc269_auto_create_multi_out_ctls
c_func
(paren
r_struct
id|alc_spec
...
macro_line|#define alc269_auto_create_analog_input_ctls &bslash;&n;&t;alc880_auto_create_analog_input_ctls
macro_line|#ifdef CONFIG_SND_HDA_POWER_SAVE
...
id|err
op_assign
id|alc269_auto_create_analog_input_ctls
c_func
(paren
id|spec
comma
...
macro_line|#define alc269_auto_init_multi_out&t;alc882_auto_init_multi_out
macro_line|#define alc269_auto_init_hp_out&t;&t;alc882_auto_init_hp_out
...
l_int|0x9075
comma
l_string|&quot;Airis Praxis N1212&quot;
comma
id|ALC861_ASUS_LAPTOP
)paren
comma
"&t;"
multiline_comment|/* FIXME: the below seems conflict */
"&t;"
multiline_comment|/* SND_PCI_QUIRK(0x1584, 0x9075, &quot;Uniwill&quot;, ALC861_UNIWILL_M31), */
"&t;"
id|SND_PCI_QUIRK
c_func
(paren
...
multiline_comment|/* ALC861VD has the ALC882-type input selection (but has only one ADC) */
macro_line|#define alc861vd_mux_enum_put alc882_mux_enum_put
multiline_comment|/*&n; * 2ch mode&n; */
r_struct
id|hda_channel_mode
...
comma
"&t;"
multiline_comment|/*HDA_BIND_MUTE(&quot;Front Playback Switch&quot;, 0x0c, 2, HDA_INPUT),*/
"&t;"
id|HDA_CODEC_MUTE
c_func
(paren
...
multiline_comment|/* toggle speaker-output according to the hp-jack state */
r_void
id|alc861vd_lenovo_hp_automute
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc861vd_lenovo_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc861vd_dallas_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
r_struct
id|hda_input_mux
id|alc662_eeepc_capture_source
op_assign
(brace
"&t;"
dot
...
macro_line|#define alc662_mux_enum_put alc882_mux_enum_put
multiline_comment|/*&n; * 2ch mode&n; */
r_struct
id|hda_channel_mode
...
c_func
(paren
l_string|&quot;MuteCtrl Playback Switch&quot;
comma
l_int|0x0c
comma
l_int|2
...
multiline_comment|/* unsolicited event for HP jack sensing */
r_void
id|alc662_eeepc_ep20_unsol_event
c_func
(paren
r_struct
id|hda_codec
