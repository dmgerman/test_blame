...
r_int
r_int
id|gpio_mute_led_mask
suffix:semicolon
"&t;"
r_int
r_int
id|gpio_mic_led_mask
suffix:semicolon
"&t;"
id|hda_nid_t
id|headset_mic_pin
...
macro_line|#define alc_update_coef_idx(codec, coef_idx, mask, bits_set)&t;&bslash;&n;&t;alc_update_coefex_idx(codec, 0x20, coef_idx, mask, bits_set)
...
multiline_comment|/* coef writes/updates batch */
r_struct
id|coef_fw
(brace
"&t;"
...
suffix:semicolon
macro_line|#define UPDATE_COEFEX(_nid, _idx, _mask, _val) &bslash;&n;&t;{ .nid = (_nid), .idx = (_idx), .mask = (_mask), .val = (_val) }
macro_line|#define WRITE_COEFEX(_nid, _idx, _val) UPDATE_COEFEX(_nid, _idx, -1, _val)
macro_line|#define WRITE_COEF(_idx, _val) WRITE_COEFEX(0x20, _idx, _val)
macro_line|#define UPDATE_COEF(_idx, _mask, _val) UPDATE_COEFEX(0x20, _idx, _mask, _val)
r_void
id|alc_process_coef_fw
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* Change EAPD to verb control */
r_void
id|alc_fill_eapd_coef
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
macro_line|#define alc_codec_rename(codec, name) snd_hda_codec_set_name(codec, name)
...
suffix:semicolon
"&t;"
multiline_comment|/* don&squot;t shut up pins when unloading the driver; otherwise it breaks&n;&t; * the default pin setup at the next load of the driver&n;&t; */
"&t;"
r_if
c_cond
(paren
id|codec-&gt;bus-&gt;shutdown
)paren
"&t;&t;"
r_return
suffix:semicolon
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* use read here for syncing after issuing each verb */
"&t;&t;"
r_if
c_cond
(paren
...
suffix:semicolon
"&t;"
multiline_comment|/* on some machine, the BIOS will clear the codec gpio data when enter&n;&t; * suspend, and won&squot;t restore the data after resume, so we restore it&n;&t; * in the driver.&n;&t; */
"&t;"
r_if
c_cond
(paren
...
"&t;"
r_return
id|snd_hda_gen_path_power_filter
c_func
(paren
id|codec
comma
...
multiline_comment|/* update LED status via GPIO */
r_void
id|alc_update_gpio_led
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* turn on/off mute LED via GPIO per vmaster hook */
r_void
id|alc_fixup_gpio_mute_hook
c_func
(paren
r_void
op_star
...
id|codec
comma
id|spec-&gt;gpio_mute_led_mask
comma
id|enabled
)paren
suffix:semicolon
)brace
multiline_comment|/* turn on/off mic-mute LED via GPIO per capture hook */
r_void
id|alc_fixup_gpio_mic_mute_hook
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc269_fixup_hp_cap_mic_mute_hook
c_func
(paren
r_struct
id|hda_codec
...
r_void
id|alc269_fixup_hp_gpio_mic1_led
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;"
multiline_comment|/* Like hp_gpio_mic1_led, but also needs GPIO4 low to enable headphone amp */
"&t;"
r_struct
id|alc_spec
op_star
...
suffix:semicolon
"&t;"
multiline_comment|/* GPIO2 just toggles on a keypress/keyrelease cycle. Therefore&n;&t;   send both key on and key off event for every interrupt. */
"&t;"
id|input_report_key
c_func
(paren
...
id|codec
comma
l_string|&quot;Out of memory (input_allocate_device)&bslash;n&quot;
)paren
suffix:semicolon
"&t;&t;&t;"
r_return
...
id|spec-&gt;kb_dev-&gt;name
op_assign
l_string|&quot;Microphone Mute Button&quot;
suffix:semicolon
"&t;&t;"
id|spec-&gt;kb_dev-&gt;evbit
(braket
l_int|0
)braket
op_assign
...
id|codec
comma
l_string|&quot;input_register_device failed&bslash;n&quot;
)paren
suffix:semicolon
"&t;&t;&t;"
...
comma
"&t;&t;&t;&t;&t;"
id|AC_VERB_SET_GPIO_UNSOLICITED_RSP_MASK
comma
l_int|0x04
)paren
suffix:semicolon
...
comma
multiline_comment|/* SET Line1 JD to 0 */
"&t;&t;"
id|UPDATE_COEFEX
c_func
(paren
...
comma
multiline_comment|/* SET charge pump by verb */
"&t;&t;"
id|UPDATE_COEFEX
c_func
(paren
...
comma
multiline_comment|/* SET EN_OSW to 1 */
"&t;&t;"
id|UPDATE_COEF
c_func
(paren
...
comma
multiline_comment|/* Combo JD gating with LINE1-VREFO */
"&t;&t;"
id|WRITE_COEF
c_func
(paren
...
comma
multiline_comment|/* Set to TRS type */
"&t;&t;"
id|UPDATE_COEF
c_func
(paren
...
comma
multiline_comment|/* Combo Jack auto detect */
"&t;&t;"
(brace
)brace
"&t;"
...
comma
multiline_comment|/* SET EN_OSW to 0 */
"&t;&t;"
id|UPDATE_COEF
c_func
(paren
...
comma
multiline_comment|/* Combo JD gating without LINE1-VREFO */
"&t;&t;"
(brace
)brace
"&t;"
...
suffix:colon
"&t;&t;"
multiline_comment|/* Set to TRS mode */
"&t;&t;"
id|alc_write_coef_idx
c_func
(paren
...
comma
multiline_comment|/* SET Line1 JD to 1 */
"&t;&t;"
(brace
)brace
"&t;"
...
suffix:semicolon
multiline_comment|/* Headset output enable */
"&t;&t;"
multiline_comment|/* ALC298 jack type setting is the same with ALC286/ALC288 */
"&t;"
r_case
l_int|0x10ec0286
suffix:colon
...
comma
multiline_comment|/* combo jack auto switch control(Vref&n; conteol) */
"&t;&t;"
(brace
)brace
"&t;"
...
multiline_comment|/* Headset output enable */
"&t;&t;"
multiline_comment|/* ALC298 check jack type is the same with ALC286/ALC288 */
"&t;"
r_case
l_int|0x10ec0286
suffix:colon
...
r_void
id|alc288_update_headset_jack_cb
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* Headset Mic enable or disable, only for Dell Dino */
"&t;"
id|present
op_assign
id|spec-&gt;gen.hp_jack_present
...
r_void
id|alc_fixup_headset_mode_dell_alc288
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* fixup for Thinkpad docks: add dock pins, avoid HP parser fixup */
r_void
id|alc_fixup_tpt440_dock
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;&t;"
id|codec-&gt;power_save_node
op_assign
l_int|0
suffix:semicolon
multiline_comment|/* avoid click noises */
"&t;&t;"
id|snd_hda_apply_pincfgs
c_func
(paren
...
suffix:semicolon
"&t;"
multiline_comment|/* Prevent pop noises when headphones are plugged in */
"&t;"
id|snd_hda_codec_write
c_func
(paren
...
suffix:colon
"&t;&t;"
multiline_comment|/* mic pin 0x19 must be initialized with Vref Hi-Z, otherwise&n;&t;&t; * it causes a click noise at start up&n;&t;&t; */
"&t;&t;"
id|snd_hda_codec_set_pin_target
c_func
(paren
id|codec
comma
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* Make the internal mic the default input source. */
"&t;&t;"
r_for
c_loop
(paren
...
r_void
id|alc_fixup_headset_mode_alc662
c_func
(paren
r_struct
id|hda_codec
...
l_int|1
suffix:semicolon
multiline_comment|/* Mic-in is same pin as headphone */
"&t;&t;"
multiline_comment|/* Disable boost for mic-in permanently. (This code is only called&n;&t;&t;   from quirks that guarantee that the headphone is at NID 0x1b.) */
"&t;&t;"
id|snd_hda_codec_write
c_func
(paren
...
multiline_comment|/* Hook to update amp GPIO4 for automute */
r_void
id|alc280_hp_gpio4_automute_hook
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;"
multiline_comment|/* mute_led_polarity is set to 0, so we pass inverted value here */
"&t;"
id|alc_update_gpio_led
c_func
(paren
...
multiline_comment|/* Manage GPIOs for HP EliteBook Folio 9480m.&n; *&n; * GPIO4 is the headphone amplifier power control&n; * GPIO3 is the audio output mute indicator LED&n; */
r_void
id|alc280_fixup_hp_9480m
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;&t;"
multiline_comment|/* Set the hooks to turn the headphone amp on/off&n;&t;&t; * as needed&n;&t;&t; */
"&t;&t;"
id|spec-&gt;gen.vmaster_mute.hook
op_assign
id|alc_fixup_gpio_mute_hook
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* The GPIOs are currently off */
"&t;&t;"
id|spec-&gt;gpio_led
op_assign
l_int|0
suffix:semicolon
"&t;&t;"
multiline_comment|/* GPIO3 is connected to the output mute LED,&n;&t;&t; * high is on, low is off&n;&t;&t; */
"&t;&t;"
id|spec-&gt;mute_led_polarity
op_assign
l_int|0
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* Initialize GPIO configuration */
"&t;&t;"
id|snd_hda_add_verbs
c_func
(paren
...
comma
"&t;"
id|ALC275_FIXUP_SONY_DISABLE_AAMIX
comma
"&t;"
id|ALC271_FIXUP_DMIC
comma
...
comma
"&t;"
id|ALC269_FIXUP_LIFEBOOK_NO_HP_TO_LINEOUT
comma
"&t;"
...
comma
"&t;"
id|ALC269_FIXUP_ASPIRE_HEADSET_MIC
comma
"&t;"
...
comma
"&t;"
id|ALC282_FIXUP_ASPIRE_V5_PINS
comma
"&t;"
id|ALC280_FIXUP_HP_GPIO4
comma
...
comma
"&t;"
id|ALC280_FIXUP_HP_DOCK_PINS
comma
"&t;"
id|ALC280_FIXUP_HP_9480M
comma
"&t;"
id|ALC288_FIXUP_DELL_HEADSET_MODE
comma
"&t;"
id|ALC288_FIXUP_DELL1_MIC_NO_PRESENCE
comma
"&t;"
id|ALC288_FIXUP_DELL_XPS_13_GPIO6
comma
"&t;"
id|ALC288_FIXUP_DELL_XPS_13
comma
"&t;"
id|ALC288_FIXUP_DISABLE_AAMIX
comma
"&t;"
...
comma
"&t;"
id|ALC275_FIXUP_DELL_XPS
comma
"&t;"
id|ALC256_FIXUP_DELL_XPS_13_HEADPHONE_NOISE
comma
)brace
suffix:semicolon
r_const
...
comma
multiline_comment|/* headset mic, with jack detect */
"&t;&t;&t;"
(brace
)brace
"&t;&t;"
...
comma
multiline_comment|/* headset mic w/o jack detect */
"&t;&t;&t;"
(brace
)brace
"&t;&t;"
...
(brace
"&t;&t;&t;"
multiline_comment|/* Disable pass-through path for FRONT 14h */
"&t;&t;&t;"
(brace
l_int|0x20
comma
...
id|name
op_assign
l_string|&quot;headset-mode-no-hp-mic&quot;
)brace
comma
"&t;"
(brace
...
suffix:semicolon
macro_line|#define ALC256_STANDARD_PINS &bslash;&n;&t;{0x12, 0x90a60140}, &bslash;&n;&t;{0x14, 0x90170110}, &bslash;&n;&t;{0x21, 0x02211020}
...
l_int|0x103c
comma
l_string|&quot;HP 15 Touchsmart&quot;
comma
id|ALC269_FIXUP_HP_MUTE_LED_MIC1
comma
"&t;&t;"
id|ALC282_STANDARD_PINS
comma
"&t;&t;"
(brace
l_int|0x12
...
suffix:semicolon
r_void
id|alc668_restore_default_value
c_func
(paren
r_struct
id|hda_codec
...
comma
"&t;"
id|ALC662_FIXUP_DELL_MIC_NO_PRESENCE
comma
"&t;"
id|ALC668_FIXUP_DELL_MIC_NO_PRESENCE
comma
"&t;"
id|ALC662_FIXUP_HEADSET_MODE
comma
"&t;"
...
comma
"&t;"
id|ALC668_FIXUP_DELL_DISABLE_AAMIX
comma
"&t;"
...
multiline_comment|/* use as headset mic, without its own jack detect */
"&t;&t;&t;"
multiline_comment|/* headphone mic by setting pin control of 0x1b (headphone out) to in + vref_50 */
"&t;&t;&t;"
(brace
)brace
"&t;&t;"
