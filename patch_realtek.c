...
suffix:semicolon
"&t;"
multiline_comment|/* HP automute enabled */
"&t;"
r_int
r_int
id|detect_line
...
suffix:semicolon
"&t;"
multiline_comment|/* automute line-out as well */
"&t;"
r_int
r_int
id|automute_hp_lo
...
suffix:semicolon
"&t;"
multiline_comment|/* both HP and LO available */
"&t;"
...
multiline_comment|/* Toggle internal speakers muting */
r_void
id|update_speakers
c_func
(paren
...
l_int|1
suffix:semicolon
multiline_comment|/* both HP and LO automute */
"&t;"
r_if
c_cond
(paren
...
c_func
(paren
l_string|&quot;realtek: Enable Line-Out auto-muting &quot;
"&t;&t;&t;&t;"
l_string|&quot;on NID 0x%x&bslash;n&quot;
comma
id|nid
)paren
suffix:semicolon
...
(brace
"&t;&t;"
multiline_comment|/* first control for the volume widget */
"&t;&t;"
id|err
op_assign
id|add_pb_vol_ctrl
...
multiline_comment|/* We use two mixers depending on the output pin; 0x16 is a mono output&n; * and thus it&squot;s bound with a different mixer.&n; * This function returns which mixer amp should be used.&n; */
r_int
id|alc262_check_volbit
c_func
(paren
id|hda_nid_t
id|nid
...
multiline_comment|/* a volume control for this mixer already there */
"&t;&t;"
r_return
l_int|0
suffix:semicolon
...
r_void
id|alc268_auto_set_output_and_unmute
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* mute mixer inputs from 0x1d */
"&t;&t;"
id|snd_hda_codec_write
c_func
(paren
...
(brace
"&t;&t;"
multiline_comment|/* unmute mixer inputs from 0x1d */
"&t;&t;"
id|snd_hda_codec_write
c_func
(paren
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc268_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc268
c_func
...
macro_line|#define alc269_auto_create_multi_out_ctls &bslash;&n;&t;alc268_auto_create_multi_out_ctls
macro_line|#ifdef CONFIG_SND_HDA_POWER_SAVE
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc269_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc269
c_func
...
id|board_config
op_eq
id|ALC269_QUANTA_FL1
)paren
(brace
"&t;&t;"
multiline_comment|/* Due to a hardware problem on Lenovo Ideadpad, we need to&n;&t;&t; * fix the sample rate of analog I/O to 44.1kHz&n;&t;&t; */
"&t;&t;"
id|spec-&gt;stream_analog_playback
op_assign
op_amp
...
(brace
multiline_comment|/* wasn&squot;t filled automatically? use default */
"&t;&t;"
id|alc_auto_fill_adc_caps
c_func
(paren
...
macro_line|#define alc861_create_out_sw(codec, pfx, nid, chs) &bslash;&n;&t;__alc861_create_out_sw(codec, pfx, nid, 0, chs)
multiline_comment|/* add playback controls from the parsed DAC table */
r_int
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc861_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc861
c_func
...
macro_line|#endif
multiline_comment|/*&n; * BIOS auto configuration&n; */
macro_line|#define alc861vd_is_fixed_pin(nid)&t;((nid) &gt;= 0x14 &amp;&amp; (nid) &lt;= 0x17)
macro_line|#define alc861vd_fixed_pin_idx(nid)&t;((nid) - 0x14)
macro_line|#define alc861vd_is_multi_pin(nid)&t;((nid) &gt;= 0x18)
macro_line|#define alc861vd_multi_pin_idx(nid)&t;((nid) - 0x18)
macro_line|#define alc861vd_idx_to_dac(nid)&t;&t;((nid) + 0x02)
macro_line|#define alc861vd_dac_to_idx(nid)&t;&t;((nid) - 0x02)
...
id|nid_v
op_assign
id|alc861vd_idx_to_dac
c_func
(paren
id|alc861vd_fixed_pin_idx
c_func
(paren
id|pin
)paren
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc861vd_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc861vd
c_func
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc662_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc662
c_func
...
multiline_comment|/* add playback controls from the parsed DAC table */
r_int
id|alc680_auto_create_multi_out_ctls
c_func
(paren
r_struct
id|alc_spec
...
r_void
id|alc680_auto_set_output_and_unmute
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/*&n; */
macro_line|#ifdef CONFIG_SND_HDA_ENABLE_REALTEK_QUIRKS
macro_line|#include &quot;alc680_quirks.c&quot;
macro_line|#endif
r_int
id|patch_alc680
c_func
