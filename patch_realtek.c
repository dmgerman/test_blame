...
macro_line|#define ALC_PINCTL_SWITCH(xname, nid, mask) &bslash;&n;&t;{ .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = 0,  &bslash;&n;&t;  .info = alc_pinctl_switch_info, &bslash;&n;&t;  .get = alc_pinctl_switch_get, &bslash;&n;&t;  .put = alc_pinctl_switch_put, &bslash;&n;&t;  .private_value = (nid) | (mask&lt;&lt;16) }
...
comma
"&t;"
id|ALC_PINCTL_SWITCH
c_func
(paren
l_string|&quot;Headphone Amp Switch&quot;
comma
l_int|0x14
comma
id|PIN_HP_AMP
...
comma
multiline_comment|/* Start with mixer outputs muted */
(brace
l_int|0x08
comma
id|AC_VERB_SET_AMP_GAIN_MUTE
...
comma
multiline_comment|/* Unmute Line1 pin widget amp left and right (no equiv mixer ctrl) */
(brace
l_int|0x14
comma
id|AC_VERB_SET_AMP_GAIN_MUTE
...
comma
"&t;"
multiline_comment|/* Unmute pin widget used for Line-in (no equiv mixer ctrl) */
(brace
l_int|0x12
comma
id|AC_VERB_SET_AMP_GAIN_MUTE
...
comma
multiline_comment|/* Set ADC connection select to line in (on mic1 pin) */
(brace
l_int|0x04
comma
id|AC_VERB_SET_CONNECT_SEL
