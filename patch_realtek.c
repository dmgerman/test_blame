...
macro_line|#if IS_ENABLED(CONFIG_THINKPAD_ACPI)
macro_line|#include &lt;linux/thinkpad_acpi.h&gt;
...
(brace
"&t;&t;"
multiline_comment|/* TODO: How do I verify if it&squot;s a mono or stereo here? */
"&t;&t;"
r_bool
id|val
op_assign
...
(paren
id|KERN_WARNING
l_string|&quot;Failed to find thinkpad-acpi symbol tpacpi_led_set&bslash;n&quot;
)paren
suffix:semicolon
"&t;&t;&t;"
r_return
...
c_func
(paren
l_string|&quot;Skipping micmute LED control due to several ADCs&quot;
)paren
suffix:semicolon
"&t;&t;&t;"
r_else
