...
macro_line|#define ALC_BIND_VOL_MONO(xname, nid, channel, indices, direction) &bslash;&n;&t;{ .iface = SNDRV_CTL_ELEM_IFACE_MIXER, .name = xname, .index = 0,  &bslash;&n;&t;  .info = alc_bind_vol_info, &bslash;&n;&t;  .get = alc_bind_vol_get, &bslash;&n;&t;  .put = alc_bind_vol_put, &bslash;&n;&t;  .private_value = HDA_COMPOSE_AMP_VAL(nid, channel, indices, direction) }
macro_line|#define ALC_BIND_VOL(xname,nid,indices,dir) ALC_BIND_VOL_MONO(xname,nid,3,indices,dir)
multiline_comment|/*&n; */
