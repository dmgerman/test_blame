...
suffix:semicolon
multiline_comment|/* 0 = volume, 1 = mute */
)brace
suffix:semicolon
r_enum
(brace
...
suffix:semicolon
"&t;"
multiline_comment|/* output paths */
"&t;"
r_struct
id|snd_array
id|out_path
...
suffix:semicolon
"&t;"
multiline_comment|/* analog loopback paths */
"&t;"
r_struct
id|snd_array
id|loopback_path
...
suffix:colon
"&t;&t;&t;"
multiline_comment|/* don&squot;t reset VREF value in case it&squot;s controlling&n;&t;&t;&t; * the amp (see alc861_fixup_asus_amp_vref_0f())&n;&t;&t;&t; */
"&t;&t;&t;"
r_if
c_cond
(paren
...
multiline_comment|/* add mute for d-mic */
"&t;&t;&t;"
id|v
op_or_assign
l_int|0x80
...
multiline_comment|/* check whether the DAC is reachable from the pin */
r_bool
id|alc_auto_is_dac_reachable
c_func
(paren
r_struct
id|hda_codec
...
multiline_comment|/* get the path pointing from the given dac to pin;&n; * passing 0 to either @pin or @dac behaves as a wildcard&n; */
r_struct
id|nid_path
op_star
id|get_out_path
...
l_int|19
suffix:semicolon
multiline_comment|/* FIXME: fixed two widgets, so far */
"&t;&t;"
)brace
"&t;"
)brace
...
multiline_comment|/* is a volume or mute control already present? */
r_bool
id|__is_out_ctl_present
c_func
(paren
r_struct
id|hda_codec
...
macro_line|#define is_out_ctl_present(codec, path, nid, dir) &bslash;&n;&t;__is_out_ctl_present(codec, path, nid, dir, 3) /* check both types */
macro_line|#define is_out_vol_ctl_present(codec, nid, dir) &bslash;&n;&t;__is_out_ctl_present(codec, NULL, nid, dir, 1 &lt;&lt; NID_PATH_VOL_CTL)
macro_line|#define is_out_mute_ctl_present(codec, nid, dir) &bslash;&n;&t;__is_out_ctl_present(codec, NULL, nid, dir, 1 &lt;&lt; NID_PATH_MUTE_CTL)
r_int
id|get_default_amp_val
c_func
(paren
r_struct
id|hda_codec
...
suffix:semicolon
"&t;&t;"
multiline_comment|/* if a volume control is assigned, set the lowest level&n;&t;&t; * as default; otherwise set to 0dB&n;&t;&t; */
"&t;&t;"
r_if
c_cond
(paren
id|is_out_vol_ctl_present
c_func
(paren
id|codec
comma
...
(brace
"&t;&t;"
multiline_comment|/* if a mute control is assigned, mute as default */
"&t;&t;"
r_if
c_cond
(paren
id|is_out_mute_ctl_present
c_func
(paren
id|codec
comma
