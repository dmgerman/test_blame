...
multiline_comment|/*&n; * Control the mode of pin widget settings via the mixer.  &quot;pc&quot; is used&n; * instead of &quot;%&quot; to avoid consequences of accidently treating the % as &n; * being part of a format specifier.  Maximum allowed length of a value is&n; * 63 characters plus NULL terminator.&n; */
r_char
op_star
...
suffix:semicolon
multiline_comment|/* Mixer combinations&n; *&n; * basic: base_output + input + pc_beep + capture&n; * HP: base_output + input + capture_alt&n; * HP_3013: hp_3013 + input + capture&n; * fujitsu: fujitsu + capture&n; */
r_struct
id|snd_kcontrol_new
...
comma
multiline_comment|/* Unmute Line1 pin widget input for when this pin is used as input&n;         * (no equiv mixer ctrl).  Having input and output unmuted doesn&squot;t&n;         * seem to cause a problem.&n;         */
(brace
l_int|0x14
comma
id|AC_VERB_SET_AMP_GAIN_MUTE
