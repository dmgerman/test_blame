...
multiline_comment|/* handle the specified unsol action (ALC_XXX_EVENT) */
r_void
id|alc_exec_unsol_event
c_func
(paren
r_struct
id|hda_codec
...
(brace
"&t;&t;"
multiline_comment|/* Execute the dc-vol event here as it requires the NID&n;&t;&t; * but we don&squot;t pass NID to alc_exec_unsol_event().&n;&t;&t; * Once when we convert all static quirks to the auto-parser,&n;&t;&t; * this can be integerated into there.&n;&t;&t; */
"&t;&t;"
r_struct
id|hda_jack_tbl
op_star
...
id|jack
op_assign
id|snd_hda_jack_tbl_get_from_tag
c_func
(paren
id|codec
comma
